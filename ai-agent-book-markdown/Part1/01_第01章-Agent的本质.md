...
- 原文链接: <https://www.waylandz.com/ai-agent-book/第01章-Agent的本质/>
- Part: 1
- 类型: chapter
...
![Agent四大核心组件](/book-images/agent-components.svg)
...
![传统软件与Agent对比](/book-images/traditional-vs-agent-flow.svg)
...
![Shannon三层架构](/book-images/shannon-architecture.svg)
