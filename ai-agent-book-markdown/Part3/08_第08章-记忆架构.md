...
- 原文链接: <https://www.waylandz.com/ai-agent-book/第08章-记忆架构/>
- Part: 3
- 类型: chapter
...
![语义检索流程](/book-images/semantic-retrieval-flow.svg)
...
![记忆存储三层架构](/book-images/memory-storage-layers.svg)
