...
- 原文链接: <https://www.waylandz.com/ai-agent-book/第04章-MCP协议详解/>
- Part: 2
- 类型: chapter
...
![MCP协议架构](/book-images/mcp-architecture.svg)
...
![MCP 客户端-服务器通信](/book-images/mcp-sequence.svg)
...
**实现参考 (Shannon)**: [`tools/mcp.py`](https://github.com/Kocoro-lab/Shannon/blob/main/python/llm-service/llm_service/tools/mcp.py) - create\_mcp\_tool\_class 函数
