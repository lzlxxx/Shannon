...
- 原文链接: <https://www.waylandz.com/ai-agent-book/第31章-分层模型策略/>
- Part: 9
- 类型: chapter
...
![三层模型任务分布](/book-images/model-tiers-distribution.svg)
...
📦 **实现参考 (Shannon)**: [`config/models.yaml`](https://github.com/Kocoro-lab/Shannon/blob/main/config/models.yaml) - model\_tiers 配置
...
📦 **实现参考 (Shannon)**: [`llm_service/api/complexity.py`](https://github.com/Kocoro-lab/Shannon/blob/main/python/llm-service/llm_service/api/complexity.py) - \_heuristic\_analysis 函数
...
📦 **实现参考 (Shannon)**: [`config/models.yaml`](https://github.com/Kocoro-lab/Shannon/blob/main/config/models.yaml) - model\_capabilities 配置
